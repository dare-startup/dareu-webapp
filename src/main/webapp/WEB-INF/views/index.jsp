        ...
        <section class="dare-section py-3" id="dare-section">
            <div class="container">
                    ...
                    <div class="col-xs-12 col-md-4 col-xl-3 my-4 wow tada" data-wow-duration="2s">
                        ...
                        <a href="https://drive.google.com/file/d/0B3ywFpms_fF6N0pYU013Mk81X2c/view?usp=sharing" data-toggle="tooltip" data-placenement="top" title="This mobile version is still on development"><img class="my-3" src="${pageContext.request.contextPath}/resources/img/google_play.svg" alt="Play-Services logo"></a>
                    </div>
                </div>
            </div>
        </section>
